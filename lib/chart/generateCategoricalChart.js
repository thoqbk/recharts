  ...
  var CategoricalChartWrapper = (_temp = _class = function (_Component) {
    ...
    function CategoricalChartWrapper(props) {
      ...
      _this.handleTouchMove = function (e) {
        if (e.changedTouches != null && e.changedTouches.length > 0 && _this.state.isTooltipActive) {
          var changedTouch = e.changedTouches[0];
          _this.processTouch(changedTouch);
        }
      };
      ...
      _this.handleTouchStart = function (e) {
        ...
        _this.horizontalMoves = 0;
        _this.touchStartTime = new Date().getTime();
        var changedTouch = Object.assign({}, e.changedTouches[0]);
        if (_this.state.isTooltipActive) {
          var offset = _this.state.offset;

          var container = _this.container;
          var containerOffset = (0, _DOMUtils.getOffset)(container);
          var ne = (0, _DOMUtils.calculateChartCoordinate)(changedTouch, containerOffset);
          var mouse = _this.getMouseInfo(offset, ne);
          var nearCursor = _this.state.activeCoordinate != null && Math.abs(_this.state.activeCoordinate.x - ne.chartX) <= 50; //near the cursor
          if (mouse == null) {
            //tooltip is active, and touch outside the chart's body
            return;
          } else {
            if (nearCursor) {
              _this.disableScroll();
          ...
          _this.activateChartTimeout = setTimeout(function () {
            _this.disableScroll();
            _this.setState({
      ...
      _this.handleTouchEnd = function (e) {
        _this.enableScroll();
        _this.checkAndClearActivateChartTimeout();
        _this.checkAndDeactivateChart(e);
      };
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.data !== data || nextProps.children !== children || nextProps.width !== width || nextProps.height !== height || nextProps.layout !== layout || nextProps.stackOffset !== stackOffset || nextProps.margin !== margin) {
          ...
          var newState = _extends({}, defaultState, this.updateStateOfAxisMapsOffsetAndStackGroups(_extends({ props: nextProps }, defaultState)));
      ...
      */
       ...
       */
      value: function xGetMouseInfo(offset, e) {
        var isIn = e.chartX >= offset.left && e.chartX <= offset.left + offset.width && e.chartY >= offset.top && e.chartY <= offset.top + offset.height;
        ...
        var _state8 = this.state,
            ticks = _state8.orderedTooltipTicks,
            axis = _state8.tooltipAxis,
            tooltipTicks = _state8.tooltipTicks;
      ...
      key: 'processTouch',
      value: function processTouch(e) {
        var offset = this.state.offset;

        var container = this.container;
        var containerOffset = (0, _DOMUtils.getOffset)(container);
        var ne = (0, _DOMUtils.calculateChartCoordinate)(e, containerOffset);
        var mouse = this.xGetMouseInfo(offset, ne);
        if (mouse != null) {
      ...
      key: 'checkAndClearActivateChartTimeout',
      value: function checkAndClearActivateChartTimeout() {
      ...
      key: 'checkAndDeactivateChart',
      value: function checkAndDeactivateChart(touchEvent) {
        var now = new Date().getTime();
        var delta = now - this.touchStartTime;
        if (this.state.isTooltipActive && delta < 150 && touchEvent.changedTouches != null && touchEvent.changedTouches.length > 0) {
          var offset = this.state.offset;

          var container = this.container;
          var containerOffset = (0, _DOMUtils.getOffset)(container);
          var ne = (0, _DOMUtils.calculateChartCoordinate)(touchEvent.changedTouches[0], containerOffset);
          var mouse = this.getMouseInfo(offset, ne);
          if (mouse != null) {
            //touch inside chart's body
            this.setState({
              isTooltipActive: false
            });
          }
      ...
      value: function updateScrollState(enable) {
      ...
      key: 'checkHorizontalMovesAndDisableScroll',
      value: function checkHorizontalMovesAndDisableScroll() {
        var THRESHOLD = 5;
